...
4. From there find the unzipped assignment folder, in your shared folder, and select it. Look through and select the file HinLIBS.pro in the folder HinLIBS.
