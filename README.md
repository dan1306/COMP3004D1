...
3. In Qt Creator, assuming the unzipped assignment folder is available through the shared folder 
between your main PC and the VirtualBox VM, go to the Projects section and click Open (do not choose “New Project”)
4. In the unzipped assignment folder look through and select the file HinLIBS.pro
